...
// Class:      ITclusterAnalyzerCoincidences1
//
...
void ITclusterAnalyzerCoincidences1::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  for (typename edmNew::DetSetVector<SiPixelCluster>::const_iterator DSVit = clusters->begin(); DSVit != clusters->end(); DSVit++) {
    ...
    //unsigned int disk = layer - 8;
    //unsigned int mapRing = 4;
    //unsigned int mapModule = 2;

    //char type = 'L';

    //for (disk = 1; disk <= 4; disk++) {                                                                                                    
    //     for (ring = 1; ring <= 5; ring++) {                                                                                              


    //if (disk == 4 && ring == 5 && side == 2 && type == 'L' && (module % 2 == 0)) {

      //char type = 'L';

      //uint32_t ovModid = get2xRModuleMap(disk, ring, module, type, mapRing, mapModule, side);

      //std::cout << disk <<"     " << ring << "      " << module << "      " << type << "      " << mapRing << "      " << mapModule <<  "  "<< ovModid << std::endl;

      //std::cout << ovModid << "       " << ring << "       " << module << "       " << mapRing << "      " << mapModule << std::endl; 
...
uint32_t ITclusterAnalyzerCoincidences1::get2xRModuleMap(unsigned int disk, unsigned int ring, unsigned int mod, int type, unsigned int& mapRing, unsigned int& mapModule, unsigned int side) {
  ...
  if (side == 2) {
    if (disk == 1) {
      ...
      if(ring == 5 && mod == 1) { mapRing = 4; mapModule = 11;}
      if(ring == 5 && mod == 3) { mapRing = 4; mapModule = 3;}
      if(ring == 5 && mod == 5) { mapRing = 4; mapModule = 5;}
      if(ring == 5 && mod == 7) { mapRing = 4; mapModule = 7;}
      if(ring == 5 && mod == 9) { mapRing = 4; mapModule = 9;}
      if(ring == 5 && mod == 11) { mapRing = 4; mapModule = 11;}
      if(ring == 5 && mod == 13) { mapRing = 4; mapModule = 13;}
      if(ring == 5 && mod == 15) { mapRing = 4; mapModule = 13;}
      if(ring == 5 && mod == 17) { mapRing = 4; mapModule = 15;}
      if(ring == 5 && mod == 19) { mapRing = 4; mapModule = 17;}
      if(ring == 5 && mod == 21) { mapRing = 4; mapModule = 19;}
      if(ring == 5 && mod == 23) { mapRing = 4; mapModule = 21;}
      if(ring == 5 && mod == 25) { mapRing = 4; mapModule = 23;}
      if(ring == 5 && mod == 27) { mapRing = 4; mapModule = 25;}
      if(ring == 5 && mod == 29) { mapRing = 4; mapModule = 27;}
      if(ring == 5 && mod == 31) { mapRing = 4; mapModule = 29;}
      if(ring == 5 && mod == 33) { mapRing = 4; mapModule = 31;}
      if(ring == 5 && mod == 35) { mapRing = 4; mapModule = 33;}
      if(ring == 5 && mod == 37) { mapRing = 4; mapModule = 35;}
      if(ring == 5 && mod == 39) { mapRing = 4; mapModule = 35;}
      if(ring == 5 && mod == 41) { mapRing = 4; mapModule = 37;}
      if(ring == 5 && mod == 43) { mapRing = 4; mapModule = 39;}
      if(ring == 5 && mod == 45) { mapRing = 4; mapModule = 41;}
      if(ring == 5 && mod == 47) { mapRing = 4; mapModule = 43;}
      }
      ...
      if(ring == 5 && mod == 2) { mapRing = 4; mapModule = 2;}
      if(ring == 5 && mod == 4) { mapRing = 4; mapModule = 4;}
      if(ring == 5 && mod == 6) { mapRing = 4; mapModule = 6;}
      if(ring == 5 && mod == 8) { mapRing = 4; mapModule = 8;}
      if(ring == 5 && mod == 10) { mapRing = 4; mapModule = 10;}
      if(ring == 5 && mod == 12) { mapRing = 4; mapModule = 12;}
      if(ring == 5 && mod == 14) { mapRing = 4; mapModule = 14;}
      if(ring == 5 && mod == 16) { mapRing = 4; mapModule = 14;}
      if(ring == 5 && mod == 18) { mapRing = 4; mapModule = 16;}
      if(ring == 5 && mod == 20) { mapRing = 4; mapModule = 18;}
      if(ring == 5 && mod == 22) { mapRing = 4; mapModule = 20;}
      if(ring == 5 && mod == 24) { mapRing = 4; mapModule = 22;}
      if(ring == 5 && mod == 26) { mapRing = 4; mapModule = 24;}
      if(ring == 5 && mod == 28) { mapRing = 4; mapModule = 26;}
      if(ring == 5 && mod == 30) { mapRing = 4; mapModule = 28;}
      if(ring == 5 && mod == 32) { mapRing = 4; mapModule = 30;}
      if(ring == 5 && mod == 34) { mapRing = 4; mapModule = 32;}
      if(ring == 5 && mod == 36) { mapRing = 4; mapModule = 34;}
      if(ring == 5 && mod == 38) { mapRing = 4; mapModule = 34;}
      if(ring == 5 && mod == 40) { mapRing = 4; mapModule = 36;}
      if(ring == 5 && mod == 42) { mapRing = 4; mapModule = 38;}
      if(ring == 5 && mod == 44) { mapRing = 4; mapModule = 40;}
      if(ring == 5 && mod == 46) { mapRing = 4; mapModule = 42;}
      if(ring == 5 && mod == 48) { mapRing = 4; mapModule = 44;}
      }      
